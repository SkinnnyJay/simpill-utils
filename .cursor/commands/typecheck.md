---
description: Run TypeScript type checking and fix all type errors. Follow the fixing workflow when resolving errors.
---
...
**Context:** For a **single util package**: `cd utils/@simpill-<name>.utils && npm run typecheck`. For **all utils** from repo root: `make utils-typecheck`.
