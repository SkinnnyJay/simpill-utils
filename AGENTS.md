...
| `@simpill/acp-llm-cli` | ACP LLM CLI harness; **submodule** `utils/@simpill-acp-llm-cli.utils/` → [acp-llm-cli](https://github.com/SkinnnyJay/acp-llm-cli); npm `@simpill/acp-llm-cli` | New |
