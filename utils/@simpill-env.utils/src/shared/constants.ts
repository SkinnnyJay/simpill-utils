...
export const ENV_ERROR_MESSAGE = {
  ...
  /** Value is required (empty string) */
...
/** Prefix for enum validation error reason (append allowed values). */
export const ENV_VALIDATION_MUST_BE_ONE_OF_PREFIX = "must be one of: " as const;
