# @simpill/annotations.utils – Agent guidelines

## Structure

- **src/shared/** – metadata-store; runtime-agnostic.
- **src/client** and **src/server** – Re-export shared.
- **__tests__/shared/unit/** – Unit tests for all public APIs.

## Conventions

- Use symbol keys for private annotations; 80%+ coverage; file size limit 400 lines.
