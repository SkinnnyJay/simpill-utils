...
describe("per-target annotations", () => {
  ...
  it("default annotation backing is shared across isolated module copies", () => {
    let first: typeof import("../../../src/shared/annotations.utils") | undefined;
    let second: typeof import("../../../src/shared/annotations.utils") | undefined;
    jest.isolateModules(() => {
      first = require("../../../src/shared/annotations.utils");
    });
    jest.isolateModules(() => {
      second = require("../../../src/shared/annotations.utils");
    });
